#!/usr/bin/env python3
"""Run Phase 0 audit, linkage, and release-table commands."""
...
from src.phase0.patch_origin_registration import registration_arg_parser, run_registration_audit
from src.phase0.patch_similarity import run_similarity_plan, similarity_arg_parser
from src.phase0.recovery_audit import balance_arg_parser, recovery_arg_parser, run_balance_audit, run_recovery_audit
from src.phase0.review_packets import review_packet_arg_parser, run_review_packet
from src.phase0.sab_consistency_audit import run_sab_consistency_audit, sab_consistency_arg_parser
...
COMMANDS = {
    "recovery-audit": ("Patch-origin recovery audit", recovery_arg_parser, run_recovery_audit),
    "balance-audit": ("Origin patch balance audit", balance_arg_parser, run_balance_audit),
    "sab-consistency": ("SAB consistency audit", sab_consistency_arg_parser, run_sab_consistency_audit),
    ...
    "registration-audit": ("Patch-origin registration audit", registration_arg_parser, run_registration_audit),
    ...
    "same-patient-wsi": ("Same-patient WSI image relationship audit", same_patient_wsi_arg_parser, run_same_patient_wsi_relationships),
}
