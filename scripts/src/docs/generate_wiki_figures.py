...
THESIS_FIGURE_DIR = PROJECT_ROOT / "results/phase4/thesis_figures"
...
def generate_phase2_selection() -> list[dict]:
    source = PROJECT_ROOT / "results/phase2/tuning/phase2_model_selection.csv"
...
def phase2_metric_frame(model_name: str) -> pd.DataFrame:
    source = PROJECT_ROOT / "results/phase2/tuning" / f"phase2_all_results_{model_name}_averaged.csv"
...
def generate_phase2_tuning_diagnostics() -> list[dict]:
    selection_source = PROJECT_ROOT / "results/phase2/tuning/phase2_model_selection.csv"
...
def generate_dataset_diagnosis_summary() -> list[dict]:
    origin_source = PROJECT_ROOT / "results/phase3/fold_creation/fold_assignments_origin.csv"
    patch_source = PROJECT_ROOT / "results/phase3/fold_creation/fold_assignments_patch_level.csv"
...
def generate_top_cramers_v() -> list[dict]:
    source = PROJECT_ROOT / "results/phase4/dataset_statistics/categorical_association_cramers_v.csv"
...
def generate_dataset_statistics_gallery() -> list[dict]:
    ...
    matched_origin_source = PROJECT_ROOT / "results/phase3/fold_creation/fold_assignments_origin.csv"
    association_source = PROJECT_ROOT / "results/phase4/dataset_statistics/categorical_association_cramers_v.csv"
...
def fold_balance_table() -> pd.DataFrame:
    origin_path = PROJECT_ROOT / "results/phase3/fold_creation/fold_assignments_origin.csv"
    patch_path = PROJECT_ROOT / "results/phase3/fold_creation/fold_assignments_patch_level.csv"
...
def generate_fold_balance() -> list[dict]:
    source = PROJECT_ROOT / "results/phase3/fold_creation/fold_assignments_patch_level.csv"
...
def generate_fold_stratification_figures() -> list[dict]:
    source = PROJECT_ROOT / "results/phase3/fold_creation/fold_assignments_origin.csv"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Also export Plotly PNG, SVG, and PDF copies under results/phase4/thesis_figures/plotly/.",
    )
