...
TABLE_COPY_PLAN = {
    ...
    "phase0_validation_evidence": [
        "results/phase0/recovery_audit/raw_patch_inventory.csv",
        "results/phase0/recovery_audit/origin_image_inventory.csv",
        "results/phase0/recovery_audit/missing_patch_candidates.csv",
        "results/phase0/sab_consistency_audit/patch_source_convergence.csv",
        "results/phase0/sab_consistency_audit/patch_origin_plausibility_audit.csv",
        "results/phase0/sab_consistency_audit/origin_source_convergence.csv",
    ...
    "manifests": [
        ...
        "results/phase0/sab_consistency_audit/audit_summary.json",
