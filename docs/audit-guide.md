...
Read `results/phase3_fold_creation/stratification_variables_audit.csv`. Diagnosis, morphology cluster, gender, and age group must be `included_required`. A required variable that fails missingness or six-fold category support must stop the run.
